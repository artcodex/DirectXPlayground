...
{
	class SampleDirectXTKRenderer
	{
	public:
		SampleDirectXTKRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources);
	...
	private:
		...
		CD3D11_TEXTURE2D_DESC m_catDesc;

		D2D1_RECT_F m_catRect;
